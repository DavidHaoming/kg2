<template>
  <el-form ref="form" :model="form" label-width="80px" :rules="rules">
    ...
    <el-form-item label="手机号：" prop="mobile">
      <el-input v-if="isEdit" v-model="form.mobile" />
    ...
    <el-form-item label="英文名：">
      <el-input v-if="isEdit" v-model="form.enName" />
    ...
    <div class="but">
      <el-button v-if="isEdit" type="primary" @click="submit">保存</el-button>
      <el-button v-else type="primary" @click="edit">修改个人信息</el-button>
    </div>
  </el-form>
</template>
